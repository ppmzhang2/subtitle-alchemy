...
from subalch.align_script import align_idx
from subalch.align_script import get_aligned
...
def test_align_idx() -> None:
    """Test `align_idx` function."""
    idx_aligned_correct = align_idx(SEQ_LAB, SEQ_PRD)
    assert idx_aligned_correct == IDX_ALIGNED_CORRECT


def test_locate_mismatch() -> None:
    """Test `locate_mismatch` function."""
    sseq_lab, sseq_prd = locate_mismatch(IDX_ALIGNED_CORRECT, len(SEQ_PRD))
...
def test_get_mismatch_map() -> None:
    ...
    sseq_lab, sseq_prd = locate_mismatch(IDX_ALIGNED_CORRECT, len(SEQ_PRD))
    dict_wrong = get_mismatch_map(SEQ_LAB, SEQ_PRD, sseq_lab, sseq_prd)
    dict_wrong_exp = {
        1: -1,
        21: 20,
        77: 79,
...
def test_get_aligned() -> None:
    """Test `get_aligned` function."""
    idx_aligned = get_aligned(SEQ_LAB, SEQ_PRD)
